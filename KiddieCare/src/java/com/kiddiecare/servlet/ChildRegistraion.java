    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          //  String userNic = request.getParameter("guardiannic");user_user_register_no
            ...
            String sqlquery2 = "INSERT INTO child (child_birth_register_no, user_register_no, health_physician_no, family_health_physician_no, child_name, gender, dob) VALUES('" + childBirthRegisterNo + "',(select max(user_register_no)  from chdr.user where user.nic = '"+nic+"'),'" + healthPhysicianNo + "','" + familyHealthPhysicianNo + "','" + childName + "',"
                    + "'" + gender + "','" + dob + "')";
